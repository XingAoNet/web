   ...
   public  class UserState
    {
       ...
       public  string UserLogin()
       {
           ...
           {
               Template = FileOption.ReadFile("/Templates/LabelFormatTemplates/UserLogined.htm");
           ...
           {
               Template = FileOption.ReadFile("/Templates/LabelFormatTemplates/UserUnLogin.htm");
               int index = Template.LastIndexOf("{注释线-");
               if (index > 0)
                   Template = Template.Substring(0, index);
               //{0}--用户名文本框
