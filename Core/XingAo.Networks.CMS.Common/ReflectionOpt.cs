...
namespace XingAo.Networks.CMS.Common
{
    public static class ReflectionOpt
    {
        ...
        /// <summary>
        /// 动态调用方法,调用举例：Response.Write(Profile_String("CommClass", "CommClass", "MakeMD5", new object[] {"2222"})+"<br />");Response.Write(Profile_String("CommClass", "CommClass", "MakeMD5", new object[] { }));
        /// </summary>
