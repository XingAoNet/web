...
(function($)
{
	...
	ScratchPad.prototype = 
	{
		...
		init: function()
		{
			...
			{
				this.drawImage(this.settings.image2,this.settings.Image2Width,this.settings.Image2Height);
			}
			else
			{
		...
		{
            //var $this = this;
            //this.ctx.fillText('Happy Trails!', 200, 60, 400);  
		},
		drawImage: function(imagePath,width,height)
		{
			...
			var img = new Image();
  			img.src = imagePath;
  			$(img).load(function(){
  				$this.ctx.drawImage(img, 0, 0,width ||this.settings.width ,height ||  this.settings.height);
  				$this.setBgImage();
  			})
		},
