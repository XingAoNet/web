<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BigWheelListPage.aspx.cs" Inherits="XingAo.Networks.CMS.Web.Manager.Wechat.Sources.BigWheelListPage" %>
	    ...
	    <thead>
            ...
            <asp:repeater runat="server" ID="Rep_List">
                <ItemTemplate> 
                    <tr>
                        <td>
					    <a class="btnSelect" href="javascript:$.bringBack({txtKeys:'<%#Eval("BGuid")%>', txtKeys_text:'<%#Eval("Keys")%>','txtSource':'BigWheel','txtAutoId':'<%#Eval("ID")%>'})" title="查找带回">选择</a>
				        </td>
                        <td><%#Eval("Keys")%></td>
                        <td><%#Eval("Title")%></td>
                    </tr>  
