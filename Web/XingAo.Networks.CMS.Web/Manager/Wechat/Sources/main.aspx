<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="main.aspx.cs" Inherits="XingAo.Networks.CMS.Web.Manager.Wechat.Sources.main" %>
...
<div class="pageContent">
    <div layoutH="3" style="float:left; display:block; overflow:auto; width:120px; border:solid 1px #CCC; line-height:21px; background:#fff">
	    <ul class="tree treeFolder">
			...
			<li><a href="/Manager/Wechat/Sources/MaterialFamilyPage.aspx" target="ajax" rel="jbsxBox">素材栏目</a></li>
			<li><a href="/Manager/Wechat/Sources/ActivitiesListPage.aspx" target="ajax" rel="jbsxBox">微活动</a></li>
            <li><a href="/Manager/Wechat/Sources/ScratchCardListPage.aspx" target="ajax" rel="jbsxBox">刮刮卡</a></li>
