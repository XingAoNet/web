<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Main.aspx.cs" Inherits="XingAo.Networks.CMS.Web.Manager.Wechat.Activities.BigWheel.Main" %>
...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			<li><a class="add" href="<%=Request.GetPath() %>/Edit.aspx" target="dialog" width="1000" height="600" title="添加" rel="BigWheel_add"><span>添加</span></a></li>
			<li><a title="确实要删除这些记录吗?" target="selectedTodo" rel="ids" href="<%=Request.GetPath() %>/SaveDel.ashx" class="delete"><span>删除所选</span></a></li>
			<li><a class="edit" href="<%=Request.GetPath() %>/Edit.aspx?id={sid}" target="dialog" width="1000" height="600" title="修改" rel="BigWheel_edit" warn="请选择一条数据"><span>修改</span></a></li>
	...
	<table class="table" width="100%" layoutH="138">
		...
		<tbody>
			...
			<tr target="sid" rel="<%#Eval("ID") %>">
				...
				<td><%#Eval("OrderID")%></td>
                <td><%#Eval("CanUse")%></td>
                <td><a class="edit" href="<%=Request.GetPath()%>/ShowPrize.aspx?bguid=<%#Eval("BGuid") %>"   rel="ShowPrize" lookupGroup="txtKeys">查看</a> 
                </td>	
			</tr>
            </ItemTemplate>
            </asp:repeater>
