<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ShowPrize.aspx.cs" Inherits="XingAo.Networks.CMS.Web.Manager.Wechat.Activities.ScratchCard.ShowPrize" %>
...
<div class="pageHeader">
	<form onsubmit="return divSearch(this, 'jbsxBox');" action="<%=Request.GetPath() %>/ShowPrize.aspx?sguid=<%=Request.QueryString["sguid"]%>" method="post">
	<div class="searchBar">
