<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Main.aspx.cs" Inherits="XingAo.Networks.CMS.Web.Manager.Wechat.Articles.Main" %>
...
<div class="pageContent">
	...
	<div class="panelBar">
		<div class="pages">
			...
			<span>条，共<%=TotalCount%>条，每页<%=PageSize%>条，当前第<%=PageNum %>/<%=(TotalCount + PageNum - 1) / PageNum%>页</span>
