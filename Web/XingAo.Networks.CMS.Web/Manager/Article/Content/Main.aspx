<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Main.aspx.cs" Inherits="XingAo.Networks.CMS.Web.Manager.Article.Content.Main" %>
	...
	<table class="table" width="100%" layoutH="138">
		...
		<tbody>
			...
			<tr target="sid" rel="<%#Eval("ID") %>">
				...
				<td><a href="<%=Request.GetPath() %>/Fields/Main.aspx?ID=<%#Eval("ID") %>" target="navTab" rel="FieldnavTab" title="<%#Eval("TabName")%> 字段信息"><%#Eval("TabName")%></a></td>
