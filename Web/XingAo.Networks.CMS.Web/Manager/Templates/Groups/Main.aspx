<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Main.aspx.cs" Inherits="XingAo.Networks.CMS.Web.Manager.Templates.Groups.Main" %>
	...
	<table class="table" width="100%" layoutH="138">
		...
		<tbody>
			...
			<tr target="sid" rel="<%#Eval("ID") %>">
                ...
                <td><a href="Templates/Main.aspx?GroupID=<%#Eval("ID") %>" target="navTab" rel="navTab_Templates" title="<%#Eval("GroupName")%>">模板管理</a></td>
			</tr>
            </ItemTemplate>
            </asp:repeater>
		</tbody>
