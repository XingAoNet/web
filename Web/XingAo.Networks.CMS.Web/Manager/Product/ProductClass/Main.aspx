<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Main.aspx.cs" Inherits="XingAo.Networks.CMS.Web.Manager.Product.ProductClass.Main" %>
...
<div class="pageHeader">
	...
	<div class="searchBar">
		<table class="searchContent">
			<tr>
				<td>
					类别名称：<input type="text" name="keyString" value="<%=keyString %>" />
				</td>
			</tr>
		</table>
		<div class="subBar">
...
<div class="pageContent">
	...
	<table class="table" width="100%" layoutH="138">
		...
		<tbody>
			...
			<tr target="sid" rel="<%#Eval("ID") %>">
                ...
                <td><a href="<%=Request.GetPath() %>/Move.ashx?Par=<%#Eval("ID") %>|1" target="ajaxTodo" onclick="return false;">↑</a>&nbsp;&nbsp;<a href="<%=Request.GetPath() %>/Move.ashx?Par=<%#Eval("ID") %>|0" target="ajaxTodo" onclick="return false;">↓</a></td>
				<td class="DropAble"><%#Eval("ClassCode").ToString().Length > 4 ? "|".PadRight(Eval("ClassCode").ToString().Length / 4 * 3, '-') : ""%><%#Eval("ClassName")%></td>
	...
	<div id="Div1" style="position:absolute; width:600px; border:3px solid red; top:0; left:0; display:none; background:#FFF; padding:5px;"></div>	
