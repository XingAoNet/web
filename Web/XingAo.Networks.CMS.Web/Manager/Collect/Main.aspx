<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Main.aspx.cs" Inherits="XingAo.Networks.CMS.Web.Manager.Collect.Main" %>
...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar"> 
            ...
            <li class=""><a class="add" href="<%=Request.GetPath() %>/Edit.aspx?MenuID=<%=Request.QueryString["MenuID"]%>" target="dialog" width="1000" height="500" title="添加信息采集" rel="collect_add"><span>添加</span></a></li>
	...
	<table class="table" width="100%" layoutH="138">
		...
		<tbody>
			...
			<tr target="sid" rel="<%#Eval("ID") %>">
                ...
                <td><%#Eval("Url")%></td>	
                <td><a href="<%=Request.GetPath() %>/DoAction.aspx?ID=<%#Eval("ID") %>" target="navTab" rel="page1" external="true">采集</a></td>
			</tr>
            </ItemTemplate>
            </asp:repeater>
		</tbody>
