...
namespace XingAo.Networks.CMS.Web.Manager.FriendLink.FriendLink//----------修改命名空间
{
    /// <summary>
    /// SaveDel 的摘要说明
    /// </summary>
    ...
    {
        readonly string navTabId = "navTab_Friend";//----------修改标签ID
        public void ProcessRequest(HttpContext context)
        {
            ...
            {
                Model.FriendLink mode;
                if (id > 0)
                    mode = uk.FindSigne<Model.FriendLink>(p => p.ID == id);
                else
                {
                    mode = new Model.FriendLink();
                   
                }
                mode.GroupID = context.Request.Form["txtGroupID"].ObjToInt();
                mode.LinkUrl = context.Request.Form["txtLinkUrl"];
                mode.Pic = context.Request.Form["txtPic"];
            ...
            else//删除
            {
                ...
                uk.Remove<Model.FriendLink>(p => ID.Contains(p.ID.ToString()));
