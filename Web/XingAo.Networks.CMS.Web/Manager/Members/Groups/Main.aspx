<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Main.aspx.cs" Inherits="XingAo.Networks.CMS.Web.Manager.Members.Groups.Main" %>
...
<div class="pageHeader">
	...
	<div class="searchBar">
		<table class="searchContent">
			<tr>
				<td>
					组名：<input type="text" name="keyString" value="<%=keyString %>" />
				</td>
			</tr>
		</table>
		<div class="subBar">
...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar"> 
			...
			<li><a class="edit" href="<%=Request.GetPath() %>/Edit.aspx?MenuID=<%=Request.QueryString["MenuID"]%>&id={sid}" target="dialog" warn="请选择一条数据"><span>修改</span></a></li>
	...
	<table class="table" width="100%" layoutH="138">
		...
		<tbody>
			...
			<tr target="sid" rel="<%#Eval("ID") %>">
				...
				<td><%#Eval("GroupDescribe")%></td>	
                <%--<td><a href="SysConfigs/Authoritys/AffiliatedUsers.aspx?GroupID=<%#Eval("GroupId") %>" target="navTab" rel="Nav_Affiliated" title="隶属<%#Eval("GroupName")%>成员">用户</a></td>		--%>		
			</tr>
            </ItemTemplate>
            </asp:repeater>
		</tbody>
