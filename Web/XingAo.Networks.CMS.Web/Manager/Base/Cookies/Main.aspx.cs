...
namespace XingAo.Networks.CMS.Web.Manager.Base.Cookies
{
    public partial class Main : Common.BaseListPage
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                CookiesHelp.CookiesModel[] models = CookiesHelp.GetCookiesList();
                Rep_List.DataSource = models;
                TotalCount = models.Count();//绑定前必须给总记录数赋值
                Rep_List.DataBind();
            }
        }
    }
