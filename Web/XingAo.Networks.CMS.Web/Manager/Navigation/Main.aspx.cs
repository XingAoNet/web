    ...
    public partial class Main : Common.BaseListPage
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                var where = QueryBuilder.Create<Model.WebNavigation>()
                ...
                Rep_List.DataSource = uk.LoadWhereLambda<Model.WebNavigation>(where.Expression, p => p.OrderBy(c => c.Code), PageNum, PageSize, out r).ToList();
