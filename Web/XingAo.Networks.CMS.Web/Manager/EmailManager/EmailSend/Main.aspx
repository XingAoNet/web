<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Main.aspx.cs" Inherits="XingAo.Networks.CMS.Web.Manager.EmailManager.EmailSend.Main" %>
<%@ Import Namespace="XingAo.Core" %>
<%@ Import Namespace="XingAo.Networks.CMS.Model.Email" %>
...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			<li><a class="add" href="<%=Request.GetPath() %>/Edit.aspx" target="dialog" width="1000" height="500" title="添加发送邮件" rel="email_template_edit"><span>添加</span></a></li>
			<li><a title="确实要删除这些记录吗?" target="selectedTodo" rel="ids" href="<%=Request.GetPath() %>/SaveDel.ashx" class="delete"><span>删除所选</span></a></li>
			<li><a class="edit" href="<%=Request.GetPath() %>/Edit.aspx?id={sid}" target="dialog" width="1000" height="500" title="编辑发送邮件" rel="email_template_edit" warn="请选择一条数据"><span>修改</span></a></li>
	...
	<table class="table" width="100%" layoutH="138">
		<thead>
			<tr>
				...
				<th>发送标题</th>
				<th width="150">发送邮箱地址</th>
				<th width="150">接收邮箱地址</th>
				<th width="60">发送类型</th>
		...
		<tbody>
			...
			<tr target="sid" rel="<%#Eval("ID") %>">
				...
				<td><%#Eval("SendTitle")%></td>
				<td><%#Eval("SendEmailAddr")%></td>
				<td><%#Eval("ReceiveEmailAddr")%></td>
				<td><%#Eval("SendType")%></td>
				<td><%#Eval("SendTime")%></td>				
			</tr>
            </ItemTemplate>
