...
function nextAdNetscape() {
    if (TimeOut == 5000) {
        ...
        document.getElementById('imglink' + adNum).src = "/Themes/Default/images/num_" + adNum + "_on.gif";
        ...
        for (var i = 1; i <= count; i++) {
            if (i != adNum) {
                ...
                document.getElementById('imglink' + i).src = "/Themes/Default/images/num_" + i + "_off.gif";
...
if (navigator.appName == "Netscape") {
    ...
    for (var j = 1; j < imgUrl.length; j++) { document.write('&nbsp;<a href="javascript:changeimg(' + j + ')" style="cursor:hand" title="' + imgAlt[j] + '" onFocus="this.blur()"><img id="imglink' + j + '" src="/Themes/Default/images/num_' + j + '_on.gif" border="0"></a>'); }
    document.write('&nbsp;');
    document.write('<a href="javascript:start();" style="cursor:hand" title="开始" onFocus="this.blur()"><img id="imgstart" src="/Themes/Default/images/num_play.gif" border="0" style="display:none;"></a>');
    document.write('<a href="javascript:stop();" style="cursor:hand" title="暂停" onFocus="this.blur()"><img id="imgstop" src="/Themes/Default/images/num_stop.gif" border="0"></a>');
