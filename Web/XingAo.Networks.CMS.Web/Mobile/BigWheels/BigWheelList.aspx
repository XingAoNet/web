<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BigWheelList.aspx.cs" Inherits="XingAo.Networks.CMS.Web.Mobile.BigWheels.BigWheelList" %>
...
<body>
    ...
    <div id="mainmenu" class="fn-clear">
        <asp:Repeater ID="RegList" runat="server">
            ...
            <ItemTemplate>
                <li>
                    <a href="BigWheel.aspx?openid=<%=Request.QueryString["openid"]%>&bguid=<%#Eval("BGuid")%>" style="text-decoration:none">
